...
#' @params Ypre: This is a (T0 x n1+n0) matrix of pre-treatment outcome values.
...
de.bias <- function(X0, X1, Ypre, D, W){
  ...
  # Adding some checks
  if (!is.matrix(X0) || !is.matrix(X1) || !is.matrix(Ypre) || !is.vector(D)) {
